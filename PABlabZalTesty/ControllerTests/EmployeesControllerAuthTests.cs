...
{
    public class EmployeesControllerAuthTests : IClassFixture<WebApplicationFactory<Program>>
    {
        private readonly WebApplicationFactory<Program> _factory;

        public EmployeesControllerAuthTests(WebApplicationFactory<Program> factory)
        {
            _factory = factory;
        }
